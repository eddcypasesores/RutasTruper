  ...
  public RutaDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfRuta = new EntityInsertionAdapter<Ruta>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `rutas` (`id`,`nombre`,`fecha`,`fotoListadoUri`,`foliosEsperados`,`foliosRecibidosPdf`,`notas`) VALUES (nullif(?, 0),?,?,?,?,?,?)";
      }
      ...
      public List<Ruta> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new Ruta(_tmpId,_tmpNombre,_tmpFecha,_tmpFotoListadoUri,_tmpFoliosEsperados,_tmpFoliosRecibidosPdf,_tmpNotas);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public Ruta call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new Ruta(_tmpId,_tmpNombre,_tmpFecha,_tmpFotoListadoUri,_tmpFoliosEsperados,_tmpFoliosRecibidosPdf,_tmpNotas);
          } else {
            _result = null;
          }
          return _result;
